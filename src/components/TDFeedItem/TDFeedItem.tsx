...
export const TDFeedItem: React.FC<TypeFeedItemProps> = ({item}: TypeFeedItemProps) => {
        const [didLike, setIsLiked] = useState<boolean>(item.didLike);
        const [likes, setLikes] = useState<number>(item.likes);
        const [cardInView, setInView] = useState<boolean>(false);
                    ...
                    <Col>
                                        ...
                                        <Row>
                                            <Space size={8}>
                                                ...
                                                <Col>
                                                    ...
                                                    <Row>
                                                        <Space>
                                                            <Typography.Text style={{color: "#0A66C2"}}>
                                                                {item.shopName}
                                                            </Typography.Text>
                                                            ·
                        ...
                        <Col>
                            ...
                            >
                                <Col>
                                    <Row>
                                        <Space>
                                            <TDSmallLikeSVG/>
                                            <Typography.Text type="secondary">{likes} Likes</Typography.Text>
                                        </Space>
                                    </Row>
                                </Col>
                                <Col>
                                    <Typography.Text type="secondary">{item.comments} Comments</Typography.Text>
                                </Col>
                            </Row>
                            ...
                            <Row align={"middle"} style={{height: "52px"}}>
                                ...
                                <Col span={12}>
                                    <Button type="ghost" shape="circle" icon={<TDCommentSVG/>}/>
                                </Col>
                            </Row>
                        </Col>
                    </Col>
